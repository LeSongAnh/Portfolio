    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-24">
        <div className="container-custom text-center">
          <h1 className="text-5xl font-bold mb-6 text-white">Xin chào! 👋</h1>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Tôi là một lập trình viên Next.js đam mê xây dựng các ứng dụng web hiện đại, 
            nhanh chóng và hiệu quả. Khám phá các dự án của tôi và đọc blog của tôi.
          </p>
